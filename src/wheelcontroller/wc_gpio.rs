...
pub fn toggle_pins(mut state: tokio::sync::MutexGuard<'_, WheelControllerState>) -> NodeResult
{
  match state.rolling_counter {
    0 => { state.pins.pin1.set_high();  state.pins.pin2.set_low();    state.pins.pin3.set_low();    state.pins.pin4.set_low(); }
    1 => { state.pins.pin1.set_high();  state.pins.pin2.set_high();   state.pins.pin3.set_low();    state.pins.pin4.set_low(); }
    2 => { state.pins.pin1.set_low();   state.pins.pin2.set_high();   state.pins.pin3.set_low();    state.pins.pin4.set_low(); }
    3 => { state.pins.pin1.set_low();   state.pins.pin2.set_high();   state.pins.pin3.set_high();   state.pins.pin4.set_low(); }
    4 => { state.pins.pin1.set_low();   state.pins.pin2.set_low();    state.pins.pin3.set_high();   state.pins.pin4.set_low(); }
    5 => { state.pins.pin1.set_low();   state.pins.pin2.set_low();    state.pins.pin3.set_high();   state.pins.pin4.set_high(); }
    6 => { state.pins.pin1.set_low();   state.pins.pin2.set_low();    state.pins.pin3.set_low();    state.pins.pin4.set_high(); }
    7 => { state.pins.pin1.set_high();  state.pins.pin2.set_low();    state.pins.pin3.set_low();    state.pins.pin4.set_high(); }
